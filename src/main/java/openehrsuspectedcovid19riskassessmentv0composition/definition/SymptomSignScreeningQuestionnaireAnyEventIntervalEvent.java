...
@Generated(
    ...
    date = "2021-09-17T01:28:15.466660900+05:30",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.5.0"
)
@OptionFor("INTERVAL_EVENT")
public class SymptomSignScreeningQuestionnaireAnyEventIntervalEvent implements IntervalEventEntity, SymptomSignScreeningQuestionnaireAnyEventChoice {
  /**
  ...
  /**
   * Path: Suspected COVID-19 risk assessment2.v0/Symptom/sign screening questionnaire/Any event/width
   */
  @Path("/width|value")
  private TemporalAmount widthValue;

  /**
   * Path: Suspected COVID-19 risk assessment2.v0/Symptom/sign screening questionnaire/Any event/math_function
   */
  @Path("/math_function|defining_code")
  private MathFunction mathFunctionDefiningCode;

  /**
   * Path: Suspected COVID-19 risk assessment2.v0/Symptom/sign screening questionnaire/Any event/sample_count
   */
  @Path("/sample_count")
