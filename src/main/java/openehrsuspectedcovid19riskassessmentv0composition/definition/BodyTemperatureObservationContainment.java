...
public class BodyTemperatureObservationContainment extends Containment {
  ...
  public SelectAqlField<NullFlavour> TEMPERATURE_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(BodyTemperatureObservation.class, "/data[at0002]/events[at0003]/data[at0001]/items[at0004]/null_flavour|defining_code", "temperatureNullFlavourDefiningCode", NullFlavour.class, this);
