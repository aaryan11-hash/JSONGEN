...
@Generated(
    ...
    date = "2021-09-17T01:28:15.473670300+05:30",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.5.0"
)
public class SymptomSignScreeningQuestionnaireSpecificSymptomSignCluster implements LocatableEntity {
  /**
   * Path: Suspected COVID-19 risk assessment2.v0/Symptom/sign screening questionnaire/Any event/Specific symptom/sign/Symptom or sign name
  ...
  /**
   * Path: Suspected COVID-19 risk assessment2.v0/Symptom/sign screening questionnaire/Any event/Tree/Specific symptom/sign/Symptom or sign name/null_flavour
   */
  @Path("/items[at0004]/null_flavour|defining_code")
  private NullFlavour symptomOrSignNameNullFlavourDefiningCode;

  /**
   * Path: Suspected COVID-19 risk assessment2.v0/Symptom/sign screening questionnaire/Any event/Specific symptom/sign/Presence?
  ...
  /**
   * Path: Suspected COVID-19 risk assessment2.v0/Symptom/sign screening questionnaire/Any event/Tree/Specific symptom/sign/Presence?/null_flavour
   */
  @Path("/items[at0005]/null_flavour|defining_code")
  private NullFlavour presenceNullFlavourDefiningCode;

  /**
   * Path: Suspected COVID-19 risk assessment2.v0/Symptom/sign screening questionnaire/Any event/Specific symptom/sign/Onset
  ...
  /**
   * Path: Suspected COVID-19 risk assessment2.v0/Symptom/sign screening questionnaire/Any event/Tree/Specific symptom/sign/Onset/null_flavour
   */
  @Path("/items[at0006]/null_flavour|defining_code")
  private NullFlavour onsetNullFlavourDefiningCode;

  /**
   * Path: Suspected COVID-19 risk assessment2.v0/Symptom/sign screening questionnaire/Any event/Specific symptom/sign/Comment
  ...
  /**
   * Path: Suspected COVID-19 risk assessment2.v0/Symptom/sign screening questionnaire/Any event/Tree/Specific symptom/sign/Comment/null_flavour
   */
  @Path("/items[at0035]/null_flavour|defining_code")
  private NullFlavour commentNullFlavourDefiningCode;

  /**
   * Path: Suspected COVID-19 risk assessment2.v0/Symptom/sign screening questionnaire/Any event/Specific symptom/sign/feeder_audit
   */
  @Path("/feeder_audit")
